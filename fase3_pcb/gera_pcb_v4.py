...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "v4")
...
for mi, cx in enumerate(COL_X):
    for ph, y in enumerate(ROW_Y):
        ...
        place("Resistor_SMD.pretty", "R_2512_6332Metric", "Rs%s" % t, cx + 12, y + 28, 270)
...
BRD.Save(OUT + "/v4_drone.kicad_pcb")
print("salvou", OUT + "/v4_drone.kicad_pcb")
