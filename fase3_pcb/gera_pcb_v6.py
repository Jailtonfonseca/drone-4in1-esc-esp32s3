...
for mi, cx in enumerate(COL_X):
    for ph, y in enumerate(ROW_Y):
        ...
        # NO DA FASE: stub fino -> trecho largo confinado no vao entre os FETs -> stub fino
        ...
        # shunt -> via de GND (stub curto; o retorno real e' o plano de GND)
...
BRD.Save(OUT + "/v6_drone.kicad_pcb")
print("salvou", OUT + "/v6_drone.kicad_pcb")
